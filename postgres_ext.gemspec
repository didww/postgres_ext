...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{Adds Postgres CTE support to ActiveRecord}
  gem.summary       = %q{Extends ActiveRecord to handle PostgreSQL common table expressions}
  gem.homepage      = 'https://github.com/SciMed/postgres_ext'
  gem.licenses      = ['MIT']
